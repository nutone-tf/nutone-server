...
void function JoinMessage(entity player) {
    ...
    Chat_ServerPrivateMessage(player, prefix + "This server collects data using the WIP Tone API. View statistics at https://legonzaur.github.io/Tone_WebClient", false, false)
}
